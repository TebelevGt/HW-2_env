...
class PathEnv(Env):
    ...
    def generate(
        ...
        """Функция для генерации задач. Генерирует случайные связные графы и формирует промпты для них. Параметры сложности влияют на количество узлов и плотность графа."""
        data_list = []
